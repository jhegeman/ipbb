...
class VivadoProjectGenerator(object):
    ...
    def fileset(aSrcCmd):
        ...
        elif ext in ('.txt', '.wcfg'):
            # Text files are assumed to be stimulus files for simulation.
            # Vivado stores xsim waveform view configurations in .wcfg files.
            lFileSet = 'sim_1'
    ...
    def write(self, aOutput, aSettings, aComponentPaths, aCommandList, aLibs):
        ...
        lSimRuntime = aSettings.get('vivado.sim_duration', None)
        lSimRangeCheck = aSettings.get('vivado.sim_rangecheck', None)
        ...
        if lSimRuntime:
            write('set_property xsim.simulate.runtime {{{0:s}}} [get_filesets sim_1]'.format(lSimRuntime))
        if lSimRangeCheck:
            write('set_property xsim.elaborate.rangecheck {{{0:s}}} [get_filesets sim_1]'.format(lSimRangeCheck))
